...
<head>
    ...
    <title>Doacoes Realizadas</title>
    @vite([
        ...
        <div class="container-fluid">
          <a class="navbar-brand" href="{{Route('home')}}"><img src="{{Vite::asset('resources/img/HL - Logotipo - SEM LETREIRO.png')}}" class="logo"></a>
              ...
              <li class="nav-item">
                  ...
                  <li class="nav-item">
                      <a class="nav-link active" aria-current="page" href="{{Route('DoacoesRealizadas')}}">Minhas doações</a>
                  </li>
    ...
    <table class="table">
        ...
        <tbody>
            <tr>
                ...
                <br>
            <tr>
                <td><img src="{{Vite::asset('resources/img/CasaRonaldMcDonald.png')}}" alt="" width="50px" height="50px"></td>
                <td scope="row">Casa Ronald McDonald</td>
                <td>002</td>
                <td>Material</td>
                <td>2 agasalhos e uma calça </td>
                <td>05/08/2023</td>
