...
<body class="body"><br><br><br><br>
   ...
   <center> <div class="card" style="background-color:#9BF2EA;">
        ...
        <form action="{{route('password.update')}}" action="post">
            <h5>Nova senha:</h5>
            <center><input type="text" class="form-control"  aria-label="Username" aria-describedby="basic-addon1" style="width: 100%;"></center><br>
            <h5>Repita a senha:</h5>
            <center><input type="text" class="form-control"  aria-label="Username" aria-describedby="basic-addon1" style="width: 100%m;"></center>
