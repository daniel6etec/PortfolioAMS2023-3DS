...
<div class="container">
    ...
    <div class="estilo02" style=" text-align: left;">Ao desativar sua conta seus dados não serão excluidos, mas você não poderá acessar suas conversas nem notificações, não acessará os dados de suas  doações e necessidades cadastradas.</div>
        <br><br><br>
        <a  class="btn btn mb-3 py-2 px-5 mx-3" href="{{route('desativarConta', ['token' => $token])}}" style="border-radius: 10px; background: #275950;"><div style="color: #FFF; font-family: Inter; font-size: 30px; font-style: normal; font-weight: 800; line-height: normal;">Tenho certeza</div></a>
